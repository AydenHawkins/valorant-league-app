...
import * as matchParticipationsService from "./matchParticipations.service";
...
export const getMatchParticipations = async (
    ...
    try {
        const matchParticipations =
            await matchParticipationsService.getAllMatchParticipations();
...
export const getMatchParticipationById = async (
    req: Request,
    res: Response
): Promise<void> => {
    const { id } = req.params;
...
export const createMatchParticipation = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        const newMatchParticipation =
            await matchParticipationsService.createMatchParticipation(req.body);
...
export const updateMatchParticipation = async (
    ...
    try {
        const updatedMatchParticipation =
            await matchParticipationsService.updateMatchParticipation(id, req.body);
...
export const deleteMatchParticipation = async (
    req: Request,
    res: Response
): Promise<void> => {
    const { id } = req.params;
