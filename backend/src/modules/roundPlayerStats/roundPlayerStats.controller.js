...
const createRoundPlayerStat = async (req, res) => {
    try {
        const newStat = await roundPlayerStatsService.createRoundPlayerStat(req.body);
...
const updateRoundPlayerStat = async (req, res) => {
    const { id } = req.params;
    try {
        const updatedStat = await roundPlayerStatsService.updateRoundPlayerStat(id, req.body);
