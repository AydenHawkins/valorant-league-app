...
const createRoundTeamStat = async (req, res) => {
    try {
        const newRoundTeamStat = await roundTeamStatsService.createRoundTeamStat(req.body);
...
const updateRoundTeamStat = async (req, res) => {
    const { id } = req.params;
    try {
        const updatedRoundTeamStat = await roundTeamStatsService.updateRoundTeamStat(id, req.body);
